            ...
            <div class="card-body">
                <div class="table-responsive" style="overflow-y: auto;">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <?php
                            $residents = (new Resident())->getResidents();

                            if (!empty($residents)) {
                                echo '<p class="fas fa-users" id="total">Total Residents: ' . count($residents) . '</p>';
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" id="delete" data-bs-toggle="modal" data-bs-target="#deleteModal<?= $residentId ?>">
                                ...
                                echo '<tr><td colspan="16" class="text-center">No residents found.</td></tr>';
                            }
                            ?>
                        </tbody>
                    </table>
                </div>
                <?php include 'C:\xampp\htdocs\BRGY SYSTEM\modals\add_resident.modal.php'; ?>
            </div>
        </div>
    </div>
