    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p>Total households <br> registered</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6 col-md-12 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h2><?= count(array_filter($residents, function ($resident) {return $resident['Gender'] === 'Male';})) ?></h2>
      ...
      <div class="col-lg-6 col-md-12 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h2><?= count(array_filter($residents, function ($resident) {return $resident['Gender'] === 'Female';})) ?></h2>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h2><?= count(array_filter($residents, function ($resident) {return isset($resident['Age']) && $resident['Age'] < 18;})) ?></h2>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h2><?= count(array_filter($residents, function ($resident) {return isset($resident['Age']) && $resident['Age'] >= 18 && $resident['Age'] <= 24;})) ?></h2>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h2><?= count(array_filter($residents, function ($resident) {return isset($resident['Age']) && $resident['Age'] >= 25 && $resident['Age'] <= 59;})) ?></h2>
      ...
      <div class="col-lg-3 col-md-6 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            <h2><?= count(array_filter($residents, function ($resident) {return isset($resident['Age']) && $resident['Age'] >= 60;})) ?></h2>
